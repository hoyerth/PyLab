# -*- coding: utf-8 -*-
"""Byte-treuer Append H20.51 an test/SESSION_HANDOFF.md (CRLF-exklusiv).
...
APPEND = Path("test/_tmp_h20_51_append.txt")

SOLL_BYTES = 729996
SOLL_SHA = "404da1e6b5a3106160ca489a6b3ed402110915632a85828c966418bfe3e13d18"
