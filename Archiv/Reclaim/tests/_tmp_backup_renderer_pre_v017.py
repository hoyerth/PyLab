...
VIER MODI (ein Vertrag, vier Instanzen -- Spiegelspez Abschnitt 66.5
und §70):
...
AdapterMode = Literal["V01", "V014", "V015", "V016"]
...
def png_01_gesamt():
    ...
    time_axis(ax1, 0, n - 1)
    _ad = ("Adapter v0.16 (G4 + Auflagen A-1..A-4): P9-Override + Regel"
           if _AUFL else
...
def png_04_p9_regime():
    ...
    if KONF.g4_aktiv:
        _v04 = ("Adapter v0.16 (G4 + A-1..A-4): P9 mit K67-Override "
                "+ Boden" if _AUFL else
...
log = _Protokoll()
log("=" * 110)
_ADAPTER_VER = ("v0.16 (G4 + A-1..A-4)" if _AUFL
