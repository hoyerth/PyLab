...
> (Design-Doku → scripts/macro_persistence.py → scripts/tmp_phasen_volumen_profil.py
...
* `scripts/tmp_phasen_volumen_profil.py` (`find_reclaim_signals`, asymmetrische Cooldown-Trennung `D2-asym`)
...
3. **Implementierung in `scripts/tmp_phasen_volumen_profil.py`:**
...
Erteilst du die formale Freigabe, zuerst `docs/reclaim_signal_loop_design.md` auf v0.4 zu aktualisieren und unmittelbar danach die Implementierung in `scripts/macro_persistence.py` und `scripts/tmp_phasen_volumen_profil.py` vorzunehmen?
...
- **Strategie-Entscheidungen (User):**
  ...
  - (a) Baseline `scripts/tmp_phasen_volumen_profil.py` bleibt **unverändert**;
...
- Hauptskript (Baseline, unverändert): `scripts/tmp_phasen_volumen_profil.py`
