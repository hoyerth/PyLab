# -*- coding: utf-8 -*-
"""Byte-treuer Append H20.52b an test/SESSION_HANDOFF.md (CRLF-exklusiv).
...
(Zustand nach dem H20.52-Append, Commit 19f3f95).
"""
...
APPEND = Path("test/_tmp_h20_52b_append.txt")

SOLL_BYTES = 768612
SOLL_SHA = "a1db985cd530f23069b65c8da4c0964f95bda31dfb6c39306c77bad9054d8776"
