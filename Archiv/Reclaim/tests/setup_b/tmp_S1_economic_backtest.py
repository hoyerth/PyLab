...
trade-fuer-trade bis zum letzten 2026-Trade (S1-Fenster-Ende 27.08.2026).

Datenbasis: test/tmp_S1_monatslauf_2026-*.txt (7 Monatsberichte, verifiziert:
201 Trades, Summe +197.26R exakt = Baseline S1). Rein lesend (I3/I4).
Ausgabe: test/tmp_S1_economic_backtest.txt
"""
...
RISK_USD = 100.0
SL_PCT = 0.0045
OUT = Path("test/tmp_S1_economic_backtest.txt")
...
o("=" * 110)
o("WIRTSCHAFTLICHES BACKTESTING S1 (Baseline phasen_volumen_profil.py)")
o("=" * 110)
o(f"Fenster        : 2026-02-05 .. 2026-08-28 (letzter Trade 27.08.2026)")
...
o("  'grosser Gewinn, dann SLs' (z. B. T27 +17.79R, danach -461 USD bis T34).")
o("-" * 110)
o("")
