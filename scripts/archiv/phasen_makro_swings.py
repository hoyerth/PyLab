...
OUT_PNG: Path = Path(__file__).resolve().parent / "phasen_makro_swings.png"
...
STATS_TXT_DEFAULT: Path = TEST_DIR / f"stats_trades_MAKRO_{FENSTER_LABEL}.txt"
CHART_PNG_DEFAULT: Path = TEST_DIR / f"phasen_makro_swings_{FENSTER_LABEL}.png"
...
_chart_png = TEST_DIR / f"phasen_makro_swings_{_fenster_label}.png"
