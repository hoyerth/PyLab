...
| v0.4.x | 03.09.2026 | **R1_L-Preis korrigiert (User-Tippfehler):** `USER_LINES_AUG` R1_L **62.24 → 64.24** (11.08 08:30–13.08 21:15). Alle Artefakte (.txt-Referenzblock + .png-Overlay) neu erzeugt. Benchmark-Report (Tol 0.15): R1_L jetzt **PREIS-ONLY** (beste Distanz P5-L 64.198, d=0.042 centgenau, keine Zeit-Überlappung) → **6 VOLL | 2 PREIS-ONLY | 0 KEIN** (statt 6/1/1). Baseline unverändert bitgenau 27 Sig/+24.97R; `--macro-live` 25/+34.87R. |
