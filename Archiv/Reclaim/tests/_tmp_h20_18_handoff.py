# -*- coding: utf-8 -*-
"""Byte-treuer Append H20.18 an test/SESSION_HANDOFF.md (CRLF-exklusiv).
...
APPEND = Path("test/_tmp_h20_18_append.txt")

SOLL_BYTES = 452356
SOLL_SHA = "e9ed06c6781afed61e795b5a816ccec9a54819592d7434c06ca24c37f339ee45"
